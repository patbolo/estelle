  ...
  drawDSO(sky) {
    $.getJSON('assets/NI2018.json', (objects) => {
      ...
      objects.forEach((object) => {
        ...
        //mesh.rotateX(Math.acos(objPos.x / objPos.y));
        //mesh.rotateY(Math.asin(1-objPos.z / objPos.y));
        pivot.position.set(objPos.x, objPos.y, objPos.z);
        //sky.add(mesh);
      });
    });
  }
